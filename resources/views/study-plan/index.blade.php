                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('study-plan.index') }}">USEA Study Plan</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="{{ route('study-plan.create') }}" class="btn btn-success float-right p-2 m-2"> Add Study Plan
