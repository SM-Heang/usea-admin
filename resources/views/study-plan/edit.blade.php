      ...
      <div class="col-md-12">
        <form action="{{ route('study-plan.update', ['id' => $plan->study_plan_id]) }}" method="POST">
          ...
          <div class="form-outline mb-4">
            ...
            <input type="text" id="fac_icon" name="fac_icon" class="form-control" value="{{ $plan ->fac_icon}}"/>
          </div>
          ...
          <div class="form-outline mb-4">
            ...
            >
              ...
              <option value="{{$faculty->fac_id}}" {{$faculty->fac_id == $plan->fac_name ? 'selected' : ''}}>{{$faculty->fac_name_kh . ' | '. $faculty->fac_name_en}}</option>
              @endforeach 
            </select>
          </div>
          ...
          <div class="form-outline mb-4">
            ...
            >
              ...
              <option value="{{$major->major_id}}" {{$major->major_id == $plan->major_name ? 'selected' : ''}}>{{$major->major_name_kh . ' | '. $major->major_name_en}}</option>
              @endforeach 
            </select>
          </div>
          ...
          <div class="form-outline mb-4">
            ...
            <input type="text" id="major_info" name="major_info" class="form-control" value="{{ $plan ->major_info}}"/>
          </div>
          ...
          <div class="form-outline mb-4">
            ...
            >
              ...
              <option value="{{$subject->subject_id}}" {{$subject->subject_id == $plan->subject_name ? 'selected' : ''}}>{{$subject->subject_name_kh . ' | '. $subject->subject_name_en}}</option>
              @endforeach 
            </select>
          </div>
          ...
          <div class="form-outline mb-4">
            ...
            <input type="number" id="study_hour" name="study_hour" class="form-control" value="{{ $plan ->study_hour}}"/>
          </div>
          <div class="form-outline mb-4">
            <label class="form-label" for="credit">credit</label>
            <input type="number" id="credit" name="credit" class="form-control" value="{{ $plan ->credit}}"/>
          </div>
