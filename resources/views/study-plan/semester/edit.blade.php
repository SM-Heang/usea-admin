      ...
      <div class="col-md-12">
        <form action="{{ route('study-plan.semester.update', ['id' => $semester->semester_id]) }}" method="POST">
          ...
          <div class="form-outline mb-4">
            ...
            <input type="text" id="semester_name_en" name="semester_name_en" class="form-control @error('semester_name_en') is-invalid @enderror" value="{{ $semester->semester_name_en}}"/>
          ...
          <div class="form-outline mb-4">
            ...
            <input type="text" id="semester_name_kh" name="semester_name_kh" class="form-control @error('semester_name_kh') is-invalid @enderror"  value="{{ $semester->semester_name_kh}}"/>
