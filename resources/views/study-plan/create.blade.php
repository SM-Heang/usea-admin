        ...
        <form action="{{ route('study-plan.store') }}" method="POST">
          ...
          <div class="border border-1 border-primary pt-2 p-5 pb-0 mb-2 rounded-3" id="originalDiv">
            ...
            <div class="form-outline mb-4">
              ...
              >
                <option selected value="">Select Fac_icon</option>
            ...
            <div class="form-outline mb-4">
              ...
              <select
                ...
                aria-label="Default select example"
                >
                <option selected value="">Select Fac_name</option>
            ...
            <div class="form-outline mb-4">
              ...
              <select
                ...
                aria-label="Default select example"
                >
                <option selected value="">Select major_name</option>
            ...
            <div class="form-outline mb-4">
              ...
              <select
                ...
                aria-label="Default select example"
                >
                <option selected value="">Select major_info_kh</option>
                @foreach ($majors as $major)
            ...
            <div class="form-outline mb-4">
              ...
              <select
                ...
                aria-label="Default select example"
                >
                <option selected value="">Select major_info_en</option>
                @foreach ($majors as $major)
            ...
            <div class="form-outline mb-4">
              ...
              <select
                ...
                name="study_year[]"
                aria-label="Default select example">
                <option selected value="">Select study_year</option>
            ...
            <div class="form-outline mb-4">
              ...
              <select
                ...
                aria-label="Default select example"
                >
                <option selected value="">Select semester_name</option>
            ...
            <div class="form-outline mb-4">
              ...
              <select
                ...
                aria-label="Default select example"
                >
                <option selected value="">Select subject_name</option>
