      ...
      <div class="col-md-12">
        <form action="{{ route('study-plan.faculty.update', ['id' => $faculty->fac_id]) }}" method="POST">
          ...
          <div class="form-outline mb-4">
            ...
            <input type="text" id="fac_name_en" name="fac_name_en" class="form-control @error('fac_name_en') is-invalid @enderror" value="{{ $faculty->fac_name_en}}"/>
            @error('fac_name_en')
          ...
          <div class="form-outline mb-4">
            ...
            <input type="text" id="fac_name_kh" name="fac_name_kh" class="form-control @error('fac_name_kh') is-invalid @enderror"  value="{{ $faculty->fac_name_kh}}"/>
            @error('fac_name_kh')
            <div class="invalid-feedback">{{$message}}</div>
            @enderror
          </div>
