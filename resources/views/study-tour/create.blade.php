...
<!-- Main content -->
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <form action="{{ route('study-tour.store') }}" method="POST">
          @csrf
          <!-- Username input -->
        <div class="form-outline mb-4">
          <label class="form-label" for="tour_title">tour_title_en</label>
          <input type="text" id="tour_title" name="tour_title" class="form-control" />
        </div>
        <div class="form-outline mb-4">
          <label class="form-label" for="tour_title_kh">tour_title_kh</label>
          <input type="text" id="tour_title_kh" name="tour_title_kh" class="form-control" />
        </div>
        <div class="form-outline mb-4">
        ...
        <div class="form-outline mb-4">
          ...
          <input type="text" id="tour_style" name="tour_style" class="form-control" />
        </div>
