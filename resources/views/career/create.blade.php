                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xxl-12 form-outline mb-4">
                            ...
                            <input type="file" id="career_img" name="career_img" class="form-control" />
                        </div>
                        <div class="col-xxl-6 form-outline mb-4">
                            <label class="form-label" for="career_position_en">តួនាទី | Position En</label>
                            <input type="text" id="career_position_en" name="career_position_en" class="form-control" />
                        </div>
                        <div class="col-xxl-6 form-outline mb-4">
                            <label class="form-label" for="career_position_kh">តួនាទី | Position Kh</label>
                            <input type="text" id="career_position_kh" name="career_position_kh" class="form-control" />
                        </div>
                        <div class="col-xxl-6 form-outline mb-4">
                            <label class="form-label" for="career_organization_en">ឈ្មោះអង្គភាព | Organization Name En</label>
                            <input type="text" id="career_organization_en" name="career_organization_en" class="form-control" />
                        </div>
                        <div class="col-xxl-6 form-outline mb-4">
                            <label class="form-label" for="career_organization_kh">ឈ្មោះអង្គភាព | Organization Name Kh</label>
                            <input type="text" id="career_organization_kh" name="career_organization_kh" class="form-control" />
                        </div>
                        <div class="col-xxl-12 form-outline mb-4">
                        ...
                        <div class="col-xxl-6 form-outline mb-4">
                            ...
                            <textarea name="career_detail_en" id="summernote" ></textarea>
                        </div>
                        <div class="col-xxl-6 form-outline mb-4">
                            <label class="form-label" for="summernote1">ព័ត៌មានការងារ | Detail Kh</label>
                            <textarea name="career_detail_kh" id="summernote1" ></textarea>
                        </div>
                        <div class="col-xxl-6 form-outline mb-4">
                            <label class="form-label" for="location_en">ទីតាំងអង្គភាព | Location En</label>
                            <input type="text" id="location_en" name="location_en" class="form-control" />
                        </div>
                        <div class="col-xxl-6 form-outline mb-4">
                            <label class="form-label" for="location_kh">ទីតាំងអង្គភាព | Location Kh</label>
                            <input type="text" id="location_kh" name="location_kh" class="form-control" />
                        </div>
                        <div class="col-xxl-6 form-outline mb-4">
