        ...
        <div class="conatiner">
            <div class="row">
                ...
                <div class="col-xxl-6 form-outline mb-4">
                  ...
                  <!-- Content input -->
                <div class="col-xxl-6 form-outline mb-4">
                    <label class="form-label" for="summernote">Article English</label>
                    <textarea name="event_description_en" id="summernote" >{{ $events->event_description_en }}</textarea>
                </div>
                <div class="col-xxl-6 form-outline mb-4">
                    <label class="form-label" for="summernote1">Article Khmer</label>
                ...
                <div class="form-outline mb-4">
                    ...
                    <select name="event_status" id="event_status" class="form-control" value="{{ $events->event_status }}">
                      ...
                      <option value="upcoming" {{  $events->event_status == "current" ? 'selected' : '' }} >Upcoming</option>
