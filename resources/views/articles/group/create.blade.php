...
<!-- Main content -->
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <form action="{{ route('articles.group.store') }}" method="POST">
          @csrf
          <!-- Username input -->
          <div class="form-outline mb-4">
            <label class="form-label" for="title-en">group_title_en</label>
            <input type="text" id="title-en" name="group_title_en" class="form-control"/>
          </div>
          <div class="form-outline mb-4">
            <label class="form-label" for="title-kh">group_title_kh</label>
            <input type="text" id="title-kh" name="group_title_kh" class="form-control" />
          </div>
          <!-- Content input -->
          {{-- <div class="form-outline mb-4">
