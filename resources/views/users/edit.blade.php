      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="{{ route('users.create') }}">Edit User</a></li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="form-outline mb-4">
          ...
          <input type="text" id="email-verified" name="email-verified" class="form-control" value="{{ $users->email_verified_at }}"/>
        </div>
        <!-- Content input -->
        <div class="form-outline mb-4">
        ...
        <div class="form-outline mb-4">
          ...
          <input type="date" id="updated-at" name="updated-at" class="form-control" value="{{ $users->updated_at }}"/>
        </div>
